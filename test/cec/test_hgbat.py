import unittest
from ceco.cec.hgbat import Hgbat


class Test_hgbat(unittest.TestCase):
    def setUp(self):
    ...
    def test_evaluate_with_identity_rotation_and_no_shift(self):
        hgbat = Hgbat(self.rotation_identity, self.no_shift)
        input_vector = [2.0, 3.0]  # Example input
        result = hgbat.evaluate(input_vector)
    ...
    def test_evaluate_with_identity_rotation_and_shift(self):
        hgbat = Hgbat(self.rotation_identity, self.shift)
        input_vector = [2.0, 3.0]  # Example input
    ...
    def test_evaluate_with_non_identity_rotation_and_no_shift(self):
        hgbat = Hgbat(self.rotation_non_identity, self.no_shift)
        input_vector = [2.0, 3.0]  # Example input
    ...
    def test_evaluate_with_non_identity_rotation_and_shift(self):
        hgbat = Hgbat(self.rotation_non_identity, self.shift)
        input_vector = [2.0, 3.0]  # Example input
