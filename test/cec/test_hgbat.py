...
class Test_hgbat(unittest.TestCase):
    ...
    def test_evaluate_with_identity_rotation_and_no_shift(self):
        hgbat = Hgbat(self.dimension, self.rotation_identity, self.no_shift)
        ...
        term1 = np.abs(sum_x_squared ** 2 - sum_x ** 2) ** (1/2)
    ...
    def test_evaluate_with_identity_rotation_and_shift(self):
        hgbat = Hgbat(self.dimension, self.rotation_identity, self.shift)
        input_vector = np.array([2.0, 3.0])
    ...
    def test_evaluate_with_non_identity_rotation_and_shift(self):
        hgbat = Hgbat(self.dimension, self.rotation_non_identity, self.shift)
        input_vector = np.array([2.0, 3.0])
