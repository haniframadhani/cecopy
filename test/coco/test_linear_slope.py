import unittest
import numpy as np
from ceco.coco.linear_slope import Linear_slope


class Test_linear_slope(unittest.TestCase):
    def setUp(self):
        np.random.seed(42)
    ...
    def test_evaluate_at_zero_vector(self):
        ...
        z = np.where((input_vector * test_func.x_opt) <
                     5 ** 2, input_vector, test_func.x_opt)
